...
namespace Vulkan 
{
    ...
    SwapChain::SwapChain(Device& _device, VkExtent2D _windowExtent) : m_device{ _device }, m_windowExtent{ _windowExtent }
    {
        init();
    }

    SwapChain::SwapChain(Device& _device, VkExtent2D _windowExtent, std::shared_ptr<SwapChain> _previous) : m_device{ _device }, m_windowExtent{ _windowExtent }, m_oldSwapChain{_previous}
    {
        init();
